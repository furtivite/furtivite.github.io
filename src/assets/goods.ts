...
export const goods: IGoodsItem[] = [
  ...
  },
  {
    ...
    colors: ['bg-blue-400', 'bg-yellow-400'],
    sizes: [EGoodsSizes.S],
  },
  {
    id: 3,
    ...
    colors: ['bg-blue-400', 'bg-green-400'],
    sizes: [EGoodsSizes.S, EGoodsSizes.XXL],
  },
  {
    id: 4,
    isInStock: true,
    ...
    colors: ['bg-blue-400', 'bg-yellow-400'],
    sizes: [EGoodsSizes.S, EGoodsSizes.XL, EGoodsSizes.XXL],
  },
  {
    id: 5,
    isInStock: true,
    ...
    colors: ['bg-yellow-400', 'bg-green-400'],
    sizes: [EGoodsSizes.S, EGoodsSizes.M, EGoodsSizes.XL, EGoodsSizes.XXL],
  },
  {
    id: 6,
